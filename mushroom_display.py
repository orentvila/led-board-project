...
class MushroomDisplay:
    ...
    def create_mushroom_pattern(self):
        ...
        stem_width = 6
        stem_height = 10
        stem_x = center_x - stem_width // 2  # 13
        stem_y = self.height - stem_height - 2  # 28 (2 pixels above bottom)
