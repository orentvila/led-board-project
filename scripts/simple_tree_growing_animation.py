#!/usr/bin/env python3
"""
Simple Tree Growing Animation for LED Display
...
# Try to import LED controller, fall back to mock if not available
try:
            ...
            for y in range(config.TOTAL_HEIGHT):
                ...
                for x in range(config.TOTAL_WIDTH):
                    ...
                    if pixel == (0, 0, 0):  # Black
                        ...
                        line += "█"
                    elif pixel == (101, 67, 33):  # Dark brown (branches)
                        line += "▓"
...
class SimpleTreeGrowingAnimation:
    def __init__(self, led_controller):
        ...
        # Animation settings
        self.growth_speed = 0.5  # seconds between growth steps
    ...
    def run_animation(self, duration=None):
        ...
        print("🌱 Starting simple tree growing animation...")
...
def main():
    ...
    try:
        ...
        animation = SimpleTreeGrowingAnimation(led)
