...
class BirdAnimation:
    ...
    def load_piskel_frames(self, piskel_file_path=None):
        ...
        if piskel_file_path:
            with open(piskel_file_path, 'r', encoding='utf-8') as f:
        ...
        for layer_idx in range(num_layers):
            try:
                # Extract layer data
                layer_str = piskel_data['piskel']['layers'][layer_idx]
